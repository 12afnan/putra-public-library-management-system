<%@ Page Title="" Language="C#" MasterPageFile="~/MainTemp.Master" AutoEventWireup="true" CodeBehind="BookReturning.aspx.cs" Inherits="Putra_Public_Library_Management_System.BookReturning" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div style="background-image: url('images/management-bg.jpg'); background-size: cover; background-position: center; background-repeat: no-repeat;">
        <div class="container-fluid pt-5 pb-5" style="min-height: calc(100vh - 97px);">
            <div class="row">
                <!-- left card -->
                <div class="col-md-4">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col">
                                    <center>
                                        <img src="images\book-return.png" width="100" />
                                    </center>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-floating">
                                        <asp:TextBox class="form-control border border-black" ID="TextBoxBrwID" runat="server" placeholder="Borrow ID"></asp:TextBox>
                                        <label for="TextBoxBrwID">Borrow ID </label>
                                    </div>
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="Required" ControlToValidate="TextBoxBrwID" Font-Italic="True" Font-Size="Small" ForeColor="Red"></asp:RequiredFieldValidator>
                                </div>

                                <div class="col-md-6">
                                    <div class="form-floating">
                                        <asp:TextBox class="form-control border border-black" ID="TextBoxUID" runat="server" placeholder="User ID"></asp:TextBox>
                                        <label for="TextBoxBrwrID">User ID </label>
                                    </div>
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ErrorMessage="Required" ControlToValidate="TextBoxUID" Font-Italic="True" Font-Size="Small" ForeColor="Red"></asp:RequiredFieldValidator>
                                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ErrorMessage="Required" ControlToValidate="TextBoxBID" Font-Italic="True" Font-Size="Small" ForeColor="Red"></asp:RequiredFieldValidator>
                                </div>

                                <div class="col-md-6">
                                    <div class="form-floating">
                                        <asp:TextBox class="form-control border border-black" ID="TextBoxCpyNum" runat="server" placeholder="Copy Number"></asp:TextBox>
                                        <label for="TextBoxCpyNum">Copy Number </label>
                                    </div>
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ErrorMessage="Required" ControlToValidate="TextBoxCpyNum" Font-Italic="True" Font-Size="Small" ForeColor="Red"></asp:RequiredFieldValidator>
                                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-12 col-md-6 mb-3">
                                    <asp:Button class="btn btn-success w-100" ID="ButtonRet" runat="server" Text="Return" OnClick="ButtonRet_Click" />
                                </div>
                            ...
                            <div class="row">
                                <div class="col">
                                    <div style="overflow-x: auto;">
                                        <asp:GridView class="table table-striped table-bordered table-responsive" ID="GridViewReturn" runat="server" DataSourceID="SqlDataSourceIssue" AutoGenerateColumns="False" DataKeyNames="BorrowID" OnRowDataBound="GridViewReturn_RowDataBound" OnSelectedIndexChanged="GridViewReturn_SelectedIndexChanged">
                                            <Columns>
